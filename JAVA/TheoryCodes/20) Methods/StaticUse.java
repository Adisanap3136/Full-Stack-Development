...
class StaticUse
{
	public static void main(String[] args)
	{
		...
		System.out.println(ArmstrongNumber.len(88593477));
		System.out.println(ArmstrongNumber.power(2,5));
		System.out.println(ArmstrongNumber.isArmstrong(88593477));
		...
		Demo.print();
		System.out.println(Prime.isPrime(8));  //here i am calling another class static method using class name as reference
	}
}
