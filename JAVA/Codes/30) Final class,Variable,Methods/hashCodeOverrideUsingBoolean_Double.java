...
public class hashCodeOverrideUsingBoolean_Double 
{
	public static void main(String[] args)
	{
		...
		System.out.println("verifying if even i pass other object it handle or not: "+c1.equals(new hashCodeOverrideUsingBoolean_Double()));      //if we pass other class reference , we cannot get class cast exception because we handle it in camera class
